...
## 2025-06-15 - Empty States
**Learning:** Plain text empty states ("No items in list.") miss an opportunity to guide users and make the UI feel complete.
**Action:** When replacing plain text empty states, implement a structured component that includes a descriptive icon (e.g., `bi-box-seam`), a clear title (e.g., "Your list is empty"), and instructional text explaining how to populate the data. Ensure to update both server-rendered templates and client-side JavaScript rendering logic identically.
